...
|---|---|
| 当前阶段 | 阶段 C：增强功能 |
| 当前 Milestone | C.1 + C.2 完成，C.3 搁置 |
| 阶段 C 任务数 | 6 |
| 已完成 | 6 |
| 进行中 | 0 |
| 待开始 | 0 |
...
| 阶段 B：MVP 开发 | ✅ 已完成 | 2026-05-02 | 2026-05-03 |
...
| ID | 任务 | 状态 | 开始 | 完成 | 备注 |
|---|---|---|---|---|---|
| M6.1.1 | 托盘菜单 | ✅ | 2026-05-02 | 2026-05-03 | M0已完成骨架：NotifyIcon + ContextMenuStrip(Open Web/Exit) |
| M6.1.2 | 启动流程 | ✅ | 2026-05-03 | 2026-05-03 | 支持发布exe和dotnet run双模式 + 健康检测轮询 |
| M6.1.3 | 进程管理 | ✅ | 2026-05-03 | 2026-05-03 | 优雅关闭(CloseMainWindow→Kill) + 异常退出检测 |
| M6.2.1 | 前端构建配置 | ✅ | 2026-05-03 | 2026-05-03 | Vite outDir→wwwroot + Vite proxy配置 |
| M6.2.2 | 后端发布配置 | ✅ | 2026-05-03 | 2026-05-03 | API: PublishSingleFile+Trimmed / Tray: PublishSingleFile |
| M6.2.3 | 打包脚本 | ✅ | 2026-05-03 | 2026-05-03 | build.ps1：前端构建 + API发布 + TrayApp发布 |
| M6.2.4 | 整体测试 | ✅ | 2026-05-03 | 2026-05-03 | tsc 0错误, eslint 0错误0警告, 完整发布成功 |
...
| 2026-05-03 | P5 | SettingsViewer — RHF watch() React 19 不兼容导致页面转圈 | ✅ 已根本修复 | 改用 Controller 组件替代 watch() | 2026-05-03 |
...
| 2026-05-03 | M6 桌面壳+部署全部完成（7 个任务）：TrayApp增强 + 自包含发布 + 一键构建脚本 | AI |
| 2026-05-03 | 阶段 C 增强功能全部完成（6 项）：B01白屏/页面居中/Tags可点击/Dashboard TopMovies/演员头像/筛选面板重设计 | AI |
